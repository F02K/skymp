...
function ModsInventoryTable({ mods, togglingModId, onToggle }) {
  if (mods.length === 0) {
    return (
      <EmptyState
                ...
                <td>
                  <div className="mods-row__actions">
                    <button
                      ...
                      disabled={isBusy || !mod.toggleable}
              ...
              <div className="panel__header panel__header--wrap">
                ...
                <div className="button-row">
                  <button
                    type="button"
                    className="ghost-button"
                    disabled={modsRefreshing}
                    onClick={() => void refreshMods({ silent: true })}
                  >
                    <SymbolIcon name="refresh" className="button-icon" />
                    <span>{modsRefreshing ? 'Refreshing...' : 'Refresh mods'}</span>
                  </button>
                  <button
                    type="button"
                    className="ghost-button"
